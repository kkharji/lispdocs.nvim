...
local db = sqlite({uri = (vim.fn.stdpath("data") .. "/lispdocs.db"), clj = {id = {"integer", "primary", "key"}, ns = "text", name = "text", symbol = "text", arglists = "text", doc = "text", preview = "text", examples = "text", macro = "integer", static = "integer", see_alsos = "text", type = "text", notes = "text"}})
do end (_2amodule_locals_2a)["db"] = db
local function _1_(self, cb)
  local function _2_(_241)
    self:insert(_241)
    return cb()
  end
  return raw.get(_2_, "clj")
end
db.clj["seed"] = _1_
return db